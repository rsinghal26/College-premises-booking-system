...
public class SAC_adminAccept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isOnline()) {
            ...
            try {
                AlertDialog alertDialog = new AlertDialog.Builder(SAC_adminAccept.this).create();
...
//                Log.d(Constants.TAG, "Show Dialog: " + e.getMessage());
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("SAC_AcceptRequests");
    ...
    public boolean isOnline() {
        ...
        if (netInfo == null || !netInfo.isConnected() || !netInfo.isAvailable()) {
            Toast.makeText(SAC_adminAccept.this, "No Internet connection!", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser != null) {
                    ...
                    Toast.makeText(SAC_adminAccept.this, "Siging out", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(SAC_adminAccept.this, MainActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<SAC_response, SAC_adminAccept.UserResponseViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<SAC_response, SAC_adminAccept.UserResponseViewHolder>
                (SAC_response.class, R.layout.sac_accept_card, SAC_adminAccept.UserResponseViewHolder.class, mDatabase) {
            @Override
            protected void populateViewHolder(SAC_adminAccept.UserResponseViewHolder userViewHolder, SAC_response model, int position) {
